...
def main():
    ...
    SOLVE_SURF, SOLVE_RECT = makeText('New Game', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 120, WINDOWHEIGHT - 30)
    ...
    while True: #main game loop
        ...
        msg = 'Click the tile of press keys to slide' # contains the msg to show in upper left corner
